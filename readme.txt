...
= How do I control the space between lines? =

Press the spacer button in WYSIWYG visual editor (see screenshot). This will add a shortcode [spacer height="20px"] which will give you 20 pixels of extra line spacing. You can change 20px to whatever your desired line spacing is. If you use negative values the following content will be shifted upwards.
